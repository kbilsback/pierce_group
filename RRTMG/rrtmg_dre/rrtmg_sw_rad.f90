...
! JKODROS TEST
        ...
        !print*, 'N2OVMR: ',N2OVMR
        !print*, 'O2VMR: ',O2VMR
        !print*, 'ALBDIRVIS: ',ASDIR
        !print*, 'ALBDIFVIS: ',ASDIF
        !print*, 'ALBDIRNIR: ',ALDIR
        !print*, 'ALBDIFNIR: ',ALDIF
        !print*, 'SUNCOS: ',COSZEN
        !print*, 'ADJES: ',ADJES
        !print*, 'DOY: ',DYOFYR
        !print*, 'SCON: ',SCON
