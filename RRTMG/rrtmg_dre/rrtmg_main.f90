...
program rrtmg_main
  ...
  ! Met file
  character (len = *), parameter :: IN_FILE_NAME = '/pierce-scratch/kbilsback/geos_chem/projects/china_rescoal/radiative_effects/DRE/external/setup_output/globe_off.nc'
  character (len=*), parameter :: OUT_FILE_NAME = '/pierce-scratch/kbilsback/geos_chem/projects/china_rescoal/radiative_effects/DRE/external/RRTMG_output/globe_off.nc'

  ! CLOUD INPUTS
  !integer, parameter :: MNS=12, NCOL=3312, Z = 47, WVS=nbndsw, HRS=8
  integer, parameter :: MNS=12, NCOL=3312, Z = 30, WVS=nbndsw, HRS=8
  !integer, parameter :: MNS=3, NCOL=648, Z = 30, WVS=nbndsw, HRS=8
  !integer, parameter :: MNS=1, NCOL=648, Z = 30, WVS=nbndsw, HRS=8
...
!  REAL(KIND=RB) :: ALBEDO(NCOL, MNS)
  ...
  integer :: varid12, varid13, varid14, varid15, varid16, varid18
  integer :: varid19, varid20, varid21, varid22, varid17a, varid17b
  integer :: retval, rec, varid17c, varid17d
  ...
  ! AEROSOL INPUTS
  REAL(KIND=RB) :: TAUAER_SW(NCOL, Z, NBNDSW, MNS)
  REAL(KIND=RB) :: SSAAER(NCOL, Z, NBNDSW, MNS)
  REAL(KIND=RB) :: ASMAER(NCOL, Z, NBNDSW, MNS)
  ...
  retval = nf_inq_varid(ncid, "tauaer", varid20)
  retval = nf_inq_varid(ncid, "ssaaer", varid21)
  retval = nf_inq_varid(ncid, "asmaer", varid22)
  ...
  retval = nf_get_var(ncid, varid20, TAUAER_SW)
  retval = nf_get_var(ncid, varid21, SSAAER)
  retval = nf_get_var(ncid, varid22, ASMAER)
 ...
 !print*, 'TAUAER_SW: ', TAUAER_SW(2000,3,:,5)
 !print*, 'SSAAER:    ', SSAAER(2000,:,2,1)
 !print*, 'ASMAER:    ', ASMAER(2000,3,:,5)
