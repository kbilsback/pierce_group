      SUBROUTINE BHLOOP(XX,RRFREL,QQEXT,QQSCA,GGSCA)
      
      REAL  GGSCA(15,47,60,75),QQSCA(15,47,60,75),
     &     QQEXT(15,47,60,75),XX(15,47,60,75)
      COMPLEX RRFREL(15,47,60,75), Ra
      INTEGER MXNANG,NMXX
C      PARAMETER(MXNANG=1000,NMXX=15000)
      PARAMETER(MXNANG=1000,NMXX=150000)
      COMPLEX Sa(2*MXNANG-1), Sb(2*MXNANG-1)
      REAL Xa, Qea, Qsa, Ga, Qb
      INTEGER N
Cf2py intent(in) XX
Cf2py intent(in) RRFREL
Cf2py intent(out) QQEXT
Cf2py intent(out) QQSCA
         ...
         do 30 l=1, 47
            do 20 la=1,60
               do 10 lo=1,75
                  ...
                  Ra = RRFREL(i,l,la,lo)
                  N = 2
                  call BHMIE (Xa,Ra,N,Sa,Sb,Qea,Qsa,Qb,Ga)
                  QQEXT(i,l,la,lo) = Qea
                  QQSCA(i,l,la,lo) = Qsa
                  GGSCA(i,l,la,lo) = Ga
                  Qea = 0.
