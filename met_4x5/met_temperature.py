# Average surface pressure from met files
...
for mn in range(0, len(start)): #iterate through 12 months
    ...
    for dy in range(0, days[mn]): #iterate through each day of the month
        ...
        fname = 'GEOSFP.' + str(date)+'.I3.4x5.nc'
        #print(fname)
        nc_file = Dataset(fname)
        nc_data = nc_file.variables['T'][:]
...
np.savez('temperature_4x5_20160801.npz', temperature=monthly_data)
