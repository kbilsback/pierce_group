...
for mn in range(0, len(start)): #iterate through 12 months
    ...
    for dy in range(0, days[mn]): #iterate through each day of the month
        ...
        fname = 'GEOSFP.' + str(date)+'.I3.4x5.nc' #change this
        #print(fname)
        nc_file = Dataset(fname)
        nc_data = nc_file.variables['QV'][:] # dont fortget to change this!
...
np.savez('qv_4x5_20160801.npz', qv=monthly_data) #change this
